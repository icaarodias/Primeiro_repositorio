...
insert into cidade (id, nome, latitude, longitude) values (2, 'Osasco', -23.5, -46.7);

insert into cidade (id, nome, latitude, longitude) values (3, 'Barueri', -23.5, -46.8);
insert into cidade (id, nome, latitude, longitude) values (4, 'Jundiaí', -23.1, -46.8);
